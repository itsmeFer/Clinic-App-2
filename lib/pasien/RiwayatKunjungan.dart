  ...
  Future<void> fetchRiwayatKunjungan() async {
    try {
      ...
      final response = await http.get(
        Uri.parse('http://192.168.1.6:8000/api/kunjungan/riwayat/$pasienId'),
        headers: {
  ...
  Future<void> batalkanKunjungan(int kunjunganId) async {
    try {
      ...
      final response = await http.post(
        Uri.parse('http://192.168.1.6:8000/api/kunjungan/batalkan'),
        headers: {
          'Authorization': 'Bearer $token',
          'Content-Type': 'application/json',
        },
          ...
          Container(
            ...
            child: ClipRRect(
              ...
              child: pasienInfo!['foto_pasien'] != null
                  ? Image.network(
                      'http://192.168.1.6:8000/storage/${pasienInfo!['foto_pasien']}',
                      fit: BoxFit.cover,
